...
$tmp_surat = mysql_query($sql_nomer_surat);
$jml = mysql_fetch_row($tmp_surat);
			...
			if($jenis_surat == "SKA"){
				$field_tambahan ='<label>Tujuan
					...
					$mengetahui .="<div>_______________________</div></div>";
							...
							$field_tambahan ='<label>Pindah ke <span class="small">Alamat yang baru</span>
					</label>
					...
					<span class="input-link" 	onclick="tambah_pengikut(this)">

					<img src="img/edit_add.png"/>
					<span
					...
					<tr>
							...
							<th style="width:70px">Hubungan</th>
...
<div class="top-bar">
    <h1>Surat Keterangan <span id="nama_surat">
	<?php echo $nama_surat;?></span> </h1>
...
<div id="stylized" class="select-bar">
	<div class="info proses"></div>
		...
		<label>Nama Warga
		<span class="small">Pemohon surat</span> </label>
    <input type="text" name="nama" id="nama" class="isian tampil"/>
		<span class="ket"></span>

		<label >Tempat, Tanggal Lahir
		<span class="small">Tempat dan tanggal lahir</span> </label>
		<input type="text" name="t_lahir" id="t_lahir" class="isian tampil" />
		<span class="ket"></span>

		<label>Jenis Kelamin
		<span class="small">L = laki - laki, W = wanita</span> </label>
		<input type="text" name="j_kel" id="j_kel" class="isian tampil" />
		<span class="ket"></span>

		<label>Kewarganegaraan
		<span class="small">Kewarganegaraan</span> </label>
...
<div class="tanda_tangan" style="float:right">
	<div>Rancaekek Wetan, <?php echo date("d-m-Y") ?></div>
