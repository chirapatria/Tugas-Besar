...
$nama_kolom = "(data,jenis_surat,no_surat,nama_surat,tanggal,isi_surat,tanda_tangan,id_warga,nama_warga)";
$nilai_input = "('".$data."','".$jenis_surat."','".$no_surat."','".$nama_surat."',now(),'".addslashes($isi_surat)."','".addslashes($tanda_tangan)."','".$id_warga."','".$nama_warga."')"; 
